	<h2 class="centre">Formulaire d'identification</h2>
	
	<hr /><!-- pour faire un trait -->

	<p class="centre">Veuillez vous authentifier pour accéder à l'espace protégé</p>
	...
	<form class="login" action="login.php" method="post"><!-- on appelle la page login -->
		...
		<fieldset class="actions">
			<button type="submit">Connexion</button> <!-- bouton obligatoire -->
		</fieldset>
	</form>
